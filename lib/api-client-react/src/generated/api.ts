 ...
 */
export const getGenerateFirePlanUrl = () => {
  return `/api/finance/fire-plan`;
};

export const generateFirePlan = async (
  firePlanRequest: FirePlanRequest,
  options?: RequestInit,
): Promise<FirePlanResponse> => {
  return customFetch<FirePlanResponse>(getGenerateFirePlanUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(firePlanRequest),
  });
};

export const getGenerateFirePlanMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof generateFirePlan>>,
    TError,
    { data: BodyType<FirePlanRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["generateFirePlan"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return generateFirePlan(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GenerateFirePlanMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateFirePlan>>
>;
export type GenerateFirePlanMutationBody = BodyType<FirePlanRequest>;
export type GenerateFirePlanMutationError = ErrorType<unknown>;

/**
 * @summary Generate FIRE retirement plan
 */
export const useGenerateFirePlan = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getGenerateFirePlanMutationOptions(options));
};

/**
 * @summary Calculate money health score across 6 dimensions
 */
export const getCalculateHealthScoreUrl = () => {
  return `/api/finance/health-score`;
};

export const calculateHealthScore = async (
  healthScoreRequest: HealthScoreRequest,
  options?: RequestInit,
): Promise<HealthScoreResponse> => {
  return customFetch<HealthScoreResponse>(getCalculateHealthScoreUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(healthScoreRequest),
  });
};

export const getCalculateHealthScoreMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof calculateHealthScore>>,
    TError,
    { data: BodyType<HealthScoreRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["calculateHealthScore"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return calculateHealthScore(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type CalculateHealthScoreMutationResult = NonNullable<
  Awaited<ReturnType<typeof calculateHealthScore>>
>;
export type CalculateHealthScoreMutationBody = BodyType<HealthScoreRequest>;
export type CalculateHealthScoreMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getCalculateHealthScoreMutationOptions(options));
};

/**
 * @summary Analyze tax and compare regimes
 */
export const getAnalyzeTaxUrl = () => {
  return `/api/finance/tax-wizard`;
};

export const analyzeTax = async (
  taxWizardRequest: TaxWizardRequest,
  options?: RequestInit,
): Promise<TaxWizardResponse> => {
  return customFetch<TaxWizardResponse>(getAnalyzeTaxUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(taxWizardRequest),
  });
};

export const getAnalyzeTaxMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof analyzeTax>>,
    TError,
    { data: BodyType<TaxWizardRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return analyzeTax(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type AnalyzeTaxMutationResult = NonNullable<
  Awaited<ReturnType<typeof analyzeTax>>
>;
export type AnalyzeTaxMutationBody = BodyType<TaxWizardRequest>;
export type AnalyzeTaxMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getAnalyzeTaxMutationOptions(options));
};

/**
 * @summary Get AI advice for a life event
 */
export const getAnalyzeLifeEventUrl = () => {
  return `/api/finance/life-event`;
};

export const analyzeLifeEvent = async (
  lifeEventRequest: LifeEventRequest,
  options?: RequestInit,
): Promise<LifeEventResponse> => {
  return customFetch<LifeEventResponse>(getAnalyzeLifeEventUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(lifeEventRequest),
  });
};

export const getAnalyzeLifeEventMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof analyzeLifeEvent>>,
    TError,
    { data: BodyType<LifeEventRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["analyzeLifeEvent"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return analyzeLifeEvent(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type AnalyzeLifeEventMutationResult = NonNullable<
  Awaited<ReturnType<typeof analyzeLifeEvent>>
>;
export type AnalyzeLifeEventMutationBody = BodyType<LifeEventRequest>;
export type AnalyzeLifeEventMutationError = ErrorType<unknown>;

/**
 * @summary Get AI advice for a life event
 */
export const useAnalyzeLifeEvent = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getAnalyzeLifeEventMutationOptions(options));
};
...
export const getListFinancialProfilesUrl = () => {
  return `/api/finance/profiles`;
};

export const listFinancialProfiles = async (
  options?: RequestInit,
...
export const getListFinancialProfilesQueryKey = () => {
  return [`/api/finance/profiles`] as const;
};

export const getListFinancialProfilesQueryOptions = <
  TData = Awaited<ReturnType<typeof listFinancialProfiles>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listFinancialProfiles>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listFinancialProfiles>>
  > = ({ signal }) => listFinancialProfiles({ signal, ...requestOptions });
...
export type ListFinancialProfilesQueryResult = NonNullable<
  Awaited<ReturnType<typeof listFinancialProfiles>>
>;
...
export function useListFinancialProfiles<
  TData = Awaited<ReturnType<typeof listFinancialProfiles>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const saveFinancialProfile = async (
  saveFinancialProfileBody: SaveFinancialProfileBody,
  options?: RequestInit,
): Promise<FinancialProfile> => {
  return customFetch<FinancialProfile>(getSaveFinancialProfileUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(saveFinancialProfileBody),
  });
};

export const getSaveFinancialProfileMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<SaveFinancialProfileBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["saveFinancialProfile"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type SaveFinancialProfileMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveFinancialProfile>>
>;
export type SaveFinancialProfileMutationBody =
  BodyType<SaveFinancialProfileBody>;
export type SaveFinancialProfileMutationError = ErrorType<unknown>;

/**
 * @summary Save a financial profile
 */
export const useSaveFinancialProfile = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
